...
- **Custom Installation**, you shouldn't really choose this strategy, unless you are a developer and
  ...
  you can find some hints in the [developer section](/docs/developer/overview).
...
From here be dragons. You can find some hints in the [developer section](/docs/developer/overview) and consult each sub
