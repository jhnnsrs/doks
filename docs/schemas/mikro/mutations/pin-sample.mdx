...
#### [<code style={{ fontWeight: 'normal' }}>pinSample.<b>id</b></code>](#)<Bullet />[`ID!`](/docs/schemas/mikro/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>
> The ID of the representation
> 

#### [<code style={{ fontWeight: 'normal' }}>pinSample.<b>pin</b></code>](#)<Bullet />[`Boolean!`](/docs/schemas/mikro/scalars/boolean) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>
> The pin
> 
