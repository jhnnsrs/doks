---
id: representations-for-user
title: representationsForUser
...
#### [<code style={{ fontWeight: 'normal' }}>representationsForUser.<b>email</b></code>](#)<Bullet />[`String!`](/docs/schemas/mikro/scalars/string) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>
